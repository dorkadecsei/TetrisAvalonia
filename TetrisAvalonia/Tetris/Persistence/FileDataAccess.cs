    ...
    public class FileDataAccess : IDataAccess
    {
        ...
        public async Task<GameState> LoadAsync(string path)
        {
            try
            {
                ...
                // Figyelj: A ShapeType-ot a Model-ben vagy Persistence-ben definiáltad? 
                // Ha a TetrisShape a Persistence-ben maradt, akkor ez jó, de 
                // ideális esetben a TetrisShape és ShapeType is a Model-be való.
                // Feltételezem, most még a Persistence névtérben vannak az enumok.
                ...
                // Point helyett Position
                Position currentPosition = new Position(int.Parse(position[0]), int.Parse(position[1]));
                ...
                Shape currentShape = Shape.ShapeFactory(currentShapeType);
        ...
        private static void SetShapeMatrix(Shape shape, int[,] matrix)
        {
            // Ez maradhat reflection-nel, mivel a _shape protected
